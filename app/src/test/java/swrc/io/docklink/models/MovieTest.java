...
/**
 * Created by NetHead on 2015/10/31.
 */
public class MovieTest
{
    ...
    public static String doSearch(String name) throws IOException
    {
        ...
        SearchResponse response = new Gson().fromJson(new MovieTest().run(url), SearchResponse.class);
    ...
    public static String doGetInfo(String movieId) throws IOException
    {
        ...
        String response = new MovieTest().run(url);
    ...
    public static void doGetImage(String movieId, String movieName) throws IOException
    {
        ...
        String photoResponseString = new MovieTest().run(url);
    ...
    @Test
    public void testGetFromDouban() throws Exception
    {
        String name = "生活大爆炸";
